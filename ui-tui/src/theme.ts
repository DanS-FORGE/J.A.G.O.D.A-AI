...
export const DARK_SEEDS: ThemeSeeds = {
  accent: '#2FA8FF',
  // J.A.G.O.D.A identity: graphite/black ground, chrome-silver primary,
  // cyan-blue accent, red border/energy. Explicit fill seeds (not derived)
  // so the CORE surfaces stay IDENTITY, matching the brand assets exactly.
  activeRow: '#1C2E44',
  bg: '#0B0E14',
  border: '#E2334D',
  error: '#ef5350',
...
// Light-terminal seeds: darker chrome/blue/red that stay legible on white.
// Same identity as DARK_SEEDS (silver primary, cyan accent, red border),
// hand-picked for contrast on a white terminal background rather than
// algorithmically lifted — hue kept, luminance darkened to the readable pole.
