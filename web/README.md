# J.A.G.O.D.A Agent — Web UI

Browser-based dashboard for managing J.A.G.O.D.A Agent configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking only | Sidebar/mobile “J.A.G.O.D.A” — mixed case, no Mondwest, no `text-display` |
