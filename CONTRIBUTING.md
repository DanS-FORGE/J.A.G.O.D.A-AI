...
4. **`author` credits the human contributor first.** For external contributions, the contributor's real name + GitHub handle goes first (`Jane Doe (jane-doe)`); "J.A.G.O.D.A" is the secondary collaborator. If the contributor's commit shows "J.A.G.O.D.A" as author because they used Hermes to draft the skill, replace it with their actual name — credit the human, not the tool.
