...
def _update_via_zip(args, *, had_desktop_app_before_update: bool = False) -> bool:
    ...
    zip_url = (
        f"https://github.com/DanS-FORGE/J.A.G.O.D.A-AI/archive/refs/heads/{branch}.zip"
    )
...
OFFICIAL_REPO_URLS = {
    "https://github.com/DanS-FORGE/J.A.G.O.D.A-AI.git",
    "git@github.com:DanS-FORGE/J.A.G.O.D.A-AI.git",
    "https://github.com/DanS-FORGE/J.A.G.O.D.A-AI",
    "git@github.com:DanS-FORGE/J.A.G.O.D.A-AI",
}

OFFICIAL_REPO_URL = "https://github.com/DanS-FORGE/J.A.G.O.D.A-AI.git"
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from DanS-FORGE/J.A.G.O.D.A-AI.")
        print()
        try:
            response = (
        ...
        if response in {"", "y", "yes"}:
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print(
                    "  ✓ Added upstream: https://github.com/DanS-FORGE/J.A.G.O.D.A-AI.git"
                )
                has_upstream = True
            else:
            ...
            print(
                "  Skipped. Run 'git remote add upstream https://github.com/DanS-FORGE/J.A.G.O.D.A-AI.git' to add later."
            )
...
def _format_concurrent_instances_message(
    ...
    lines.append("")
    lines.append("  Close J.A.G.O.D.A Desktop, exit any open `hermes` REPLs, and")
...
def _filter_non_gateway_concurrent_instances(
    ...
    TUI shell, a J.A.G.O.D.A Desktop backend child, an unrelated ``hermes`` REPL)
