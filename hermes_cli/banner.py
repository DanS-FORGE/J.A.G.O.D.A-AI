...
_GOLD = "\033[1;38;2;232;237;245m"  # True-color #E8EDF5 bold (J.A.G.O.D.A chrome)
_BOLD = "\033[1m"
_DIM = "\033[2m"
_RST = "\033[0m"
...
_UPSTREAM_REPO_URL = "https://github.com/DanS-FORGE/J.A.G.O.D.A-AI.git"
_OFFICIAL_REPO_CANONICAL = "github.com/dans-forge/j.a.g.o.d.a-ai"
...
def _github_compare_behind(current_rev: str, target_rev: str) -> Optional[int]:
    ...
    if not (_is_full_sha(current_rev) and _is_full_sha(target_rev)):
        return None
    url = (
        "https://api.github.com/repos/dans-forge/j.a.g.o.d.a-ai/"
...
_RELEASE_URL_BASE = "https://github.com/DanS-FORGE/J.A.G.O.D.A-AI/releases/tag"
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    canonical DanS-FORGE/J.A.G.O.D.A-AI repo (forks don't get a link).
    """
...
def build_welcome_banner(console: "Console", model: str, cwd: str,
    ...
    accent = _skin_color("banner_accent", "#2FA8FF")
    dim = _skin_color("banner_dim", "#5A6B82")
    text = _skin_color("banner_text", "#E4E8EF")
    ...
    title_color = _skin_color("banner_title", "#E8EDF5")
    border_color = _skin_color("banner_border", "#E2334D")
