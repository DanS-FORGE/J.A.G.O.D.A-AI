...
.. code-block:: yaml
    ...
    branding:
      ...
      response_label: " ◉ J.A.G.O.D.A "  # Response box header label
...
.. code-block:: python
    ...
    print(skin.colors["banner_title"])    # "#E8EDF5"
...
- ``default`` — Classic J.A.G.O.D.A chrome/cyan (the current look)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic J.A.G.O.D.A — chrome and cyan",
        # Dark-authored. Values match the TUI's DARK_SEEDS so the classic CLI
        # and the TUI render the same graphite/chrome/cyan/red identity.
        "colors": {
            "banner_border": "#E2334D",
            "banner_title": "#E8EDF5",
            "banner_accent": "#2FA8FF",
            "banner_dim": "#5A6B82",
            "banner_text": "#E4E8EF",
            "ui_accent": "#2FA8FF",
            "ui_label": "#6FC3FF",
            ...
            "prompt": "#E4E8EF",
            "input_rule": "#E2334D",
            "response_border": "#E8EDF5",
            "status_bar_bg": "#141A24",
            "status_bar_text": "#C0C0C0",
            "status_bar_strong": "#E8EDF5",
            "status_bar_dim": "#5A6B82",
            "status_bar_good": "#8FBC8F",
            "status_bar_warn": "#FFC53D",
            "status_bar_bad": "#FF8C00",
            "status_bar_critical": "#FF6B6B",
            "session_label": "#6FC3FF",
            "session_border": "#8B8682",
            "completion_menu_bg": "#141A24",
            "completion_menu_current_bg": "#1C2E44",
            "selection_bg": "#1F3350",
            "shell_dollar": "#38B6FF",
            "voice_status_bg": "#141A24",
        },
        # Light overlay (merged onto `colors`; dark mode renders the vivid
        # block above untouched). Same identity as the dark block (chrome
        # primary, cyan accent, red border), hand-darkened for legibility
        # on a white terminal background instead of algorithmically lifted.
        "light_colors": {
            "banner_title": "#2E3947",
            "banner_accent": "#0B6FB0",
            "banner_dim": "#5C6B7D",
            "banner_text": "#20262E",
            "ui_accent": "#0B6FB0",
            "ui_label": "#1D6FA5",
            ...
            "ui_warn": "#D97706",
            "prompt": "#20262E",
            "response_border": "#2E3947",
            "session_label": "#1D6FA5",
            "status_bar_text": "#6F6F6F",
            "status_bar_strong": "#2E3947",
            "status_bar_dim": "#6B7A8C",
            "status_bar_good": "#2E7D32",
            "status_bar_warn": "#8A5A00",
            ...
            "completion_menu_current_bg": "#D8E4F2",
            "selection_bg": "#D4E4F7",
