"""
Interactive setup wizard for J.A.G.O.D.A.
...
def _run_setup_wizard_impl(args):
    ...
    if section:
        for key, label, func in SETUP_SECTIONS:
            if key == section:
                ...
                print(color(f"│     ◉ J.A.G.O.D.A Setup — {label:<29s} │", Colors.MAGENTA))
                print(
                    color(
                        "└─────────────────────────────────────────────────────────┘",
                        Colors.MAGENTA,
    ...
    print(
        color(
            "│  Let's configure your J.A.G.O.D.A installation.        │", Colors.MAGENTA
        )
    )
    print(
        color(
