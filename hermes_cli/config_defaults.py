"""Default configuration data for J.A.G.O.D.A.
...
DEFAULT_CONFIG = {
    ...
    "whatsapp": {
        ...
        # Default (None) uses the built-in "◉ *J.A.G.O.D.A*" header.
    ...
    # J.A.G.O.D.A Desktop (Electron app) launch options. These only affect
