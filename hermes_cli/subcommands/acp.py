...
def build_acp_parser(subparsers, *, cmd_acp: Callable) -> None:
    ...
    acp_parser = subparsers.add_parser(
        "acp",
        help="Run J.A.G.O.D.A Agent as an ACP (Agent Client Protocol) server",
        description="Start J.A.G.O.D.A Agent in ACP mode for editor integration (VS Code, Zed, JetBrains)",
    )
