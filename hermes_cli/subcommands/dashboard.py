...
def build_dashboard_parser(
    ...
    dashboard_parser = subparsers.add_parser(
        ...
        description="Launch the J.A.G.O.D.A Dashboard for managing config, API keys, and sessions",
    )
    ...
    # browser. It exists so the J.A.G.O.D.A Desktop app (and headless remote
