...
let
  ...
  sharedOptions =
    ...
    {
      enable = lib.mkEnableOption "J.A.G.O.D.A";
      ...
      # Both give the /api/ws and /api/pty sockets that J.A.G.O.D.A Desktop
      ...
      backend = {
        ...
        sessionTokenFile = mkOption {
          ...
          description = ''
            ...
            routes and the /api/ws socket. J.A.G.O.D.A Desktop presents the same
  ...
  backendDescription =
    ...
    if cfg.backend.mode == "dashboard" then
      "J.A.G.O.D.A web dashboard and desktop backend"
    else
      "J.A.G.O.D.A backend for J.A.G.O.D.A Desktop";
