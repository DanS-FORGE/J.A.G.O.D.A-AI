...
|---|---|---|
| Let people email the J.A.G.O.D.A and receive replies | Email gateway adapter on this page | None beyond an IMAP/SMTP email account |
...
- **A dedicated email account** for your J.A.G.O.D.A (don't use your personal email)
