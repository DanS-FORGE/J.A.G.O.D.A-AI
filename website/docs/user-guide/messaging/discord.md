...
5. normal J.A.G.O.D.A execution, including tools, memory, and slash commands
...
3. Enter a name for your application (e.g., "J.A.G.O.D.A") and accept the Developer Terms of Service.
4. Click **Create**.
