---
title: "J.A.G.O.D.A Skill Authoring — Author in-repo SKILL.md files: frontmatter and structure"
sidebar_label: "J.A.G.O.D.A Skill Authoring"
description: "Author in-repo SKILL.md files: frontmatter and structure"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# J.A.G.O.D.A Skill Authoring
...
author: Real Name (github-handle), J.A.G.O.D.A
license: MIT
...
- Credit the **human first**, then "J.A.G.O.D.A" as secondary collaborator: `Ben Barclay (benbarclay), J.A.G.O.D.A`.
- Never `author: J.A.G.O.D.A` alone for contributed skills — credit the human, not the tool, even (especially) when an agent drafted the text.
- Maintainer-authored skills: `Teknium (teknium1), J.A.G.O.D.A`.
...
3. **`author: J.A.G.O.D.A` on a contributed skill.** Credit the human first.
