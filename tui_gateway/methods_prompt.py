...
def _(rid, params: dict) -> dict:
    ...
    prompt = "\n".join(
        ...
        for line in [
            ...
            "Restart exactly the app intended for the Preview URL, not J.A.G.O.D.A Desktop itself.",
            ...
            "Before declaring success, verify the Preview URL responds with the intended app, not J.A.G.O.D.A Desktop. If it serves Hermes/Desktop UI or another unrelated app, stop that process and report failure.",
