...
# Configuration
REPO_URL_SSH="git@github.com:DanS-FORGE/J.A.G.O.D.A-AI.git"
REPO_URL_HTTPS="https://github.com/DanS-FORGE/J.A.G.O.D.A-AI.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/DanS-FORGE/J.A.G.O.D.A-AI/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
