...
#
# Usage:
#   iex (irm https://raw.githubusercontent.com/DanS-FORGE/J.A.G.O.D.A-AI/main/scripts/install.ps1)
#
...
$RepoUrlSsh = "git@github.com:DanS-FORGE/J.A.G.O.D.A-AI.git"
$RepoUrlHttps = "https://github.com/DanS-FORGE/J.A.G.O.D.A-AI.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/DanS-FORGE/J.A.G.O.D.A-AI/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/DanS-FORGE/J.A.G.O.D.A-AI/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/DanS-FORGE/J.A.G.O.D.A-AI/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/DanS-FORGE/J.A.G.O.D.A-AI/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
