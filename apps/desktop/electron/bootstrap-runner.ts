 ...
 * bootstrap-runner.ts
 *
 * Drives apps/desktop's first-launch install of J.A.G.O.D.A Agent by spawning
...
function downloadInstallScript(ref, destPath) {
  ...
  const url = `https://raw.githubusercontent.com/DanS-FORGE/J.A.G.O.D.A-AI/${ref}/scripts/${scriptName}`
