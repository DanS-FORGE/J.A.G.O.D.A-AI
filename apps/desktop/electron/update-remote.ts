 ...
 *
 * A public install can end up with `origin=git@github.com:DanS-FORGE/J.A.G.O.D.A-AI.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/DanS-FORGE/J.A.G.O.D.A-AI.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/dans-forge/j.a.g.o.d.a-ai'
