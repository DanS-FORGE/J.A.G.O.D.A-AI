...
test('default rows use source identity without borrowing another source title', () => {
  ...
  // label. Titled: the title wins. Untitled: it stays "J.A.G.O.D.A". Regression:
  ...
  assert.equal(name(active, undefined), 'J.A.G.O.D.A')
})
...
test('displayName: local default stays J.A.G.O.D.A; remote default uses the device label', () => {
