...
export const en: Translations = {
  ...
  notifications: {
    ...
    native: {
      ...
      inputBody: 'J.A.G.O.D.A is waiting for your response.',
      turnDoneTitle: 'J.A.G.O.D.A finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    notifications: {
      ...
      kinds: {
        ...
        input: {
          label: 'Input needed',
          description: 'J.A.G.O.D.A asked a question or needs a password or secret.'
        },
        turnDone: {
    ...
    appearance: {
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and J.A.G.O.D.A can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what J.A.G.O.D.A is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
    ...
    connections: {
      ...
      updateSkippedCloud: 'Managed by J.A.G.O.D.A Cloud',
      kindLocal: 'Local',
      ...
      kindCloudDesc: 'A hosted instance discovered through your J.A.G.O.D.A Cloud account.',
      ...
      cloudAddHint:
        'Tip: signing in under J.A.G.O.D.A Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      cloudTitle: 'J.A.G.O.D.A Cloud',
      cloudDesc: 'Sign in once to J.A.G.O.D.A Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'J.A.G.O.D.A Cloud',
      cloudSignIn: 'Sign in to J.A.G.O.D.A Cloud',
      cloudSignedIn: 'Signed in to J.A.G.O.D.A Cloud',
      cloudNeedsSignIn: 'Sign in to J.A.G.O.D.A Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your J.A.G.O.D.A Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'J.A.G.O.D.A Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of J.A.G.O.D.A Cloud',
      cloudSignedOutMessage: 'Cleared the J.A.G.O.D.A Cloud session.',
      ...
      sshHermesPathTitle: 'J.A.G.O.D.A path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — J.A.G.O.D.A found`,
      ...
      sshErrNotInstalled:
        'J.A.G.O.D.A is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the J.A.G.O.D.A path.',
      sshErrPlatform:
  ...
  starmap: {
    ...
    emptyDesc: 'As J.A.G.O.D.A builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    generatePet: {
      ...
      backgroundHint: 'You can close this — J.A.G.O.D.A will notify you when it’s done.',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. J.A.G.O.D.A will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    attachUrlDesc: 'J.A.G.O.D.A will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask J.A.G.O.D.A to open PR',
  ...
  install: {
    ...
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another J.A.G.O.D.A CLI or desktop instance is running. Stop any running J.A.G.O.D.A instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  shell: {
    ...
    statusbar: {
      ...
      connectionCloudTooltip: host => `J.A.G.O.D.A Cloud · ${host}`,
  ...
  preview: {
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'J.A.G.O.D.A is restarting...',
      askRestart: 'Ask J.A.G.O.D.A to restart the server',
      lookingRestart: taskId => `J.A.G.O.D.A is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'J.A.G.O.D.A is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask J.A.G.O.D.A to open a page.',
      finishedRestarting: message => `J.A.G.O.D.A finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'J.A.G.O.D.A could not restart the server.',
      stillWorking:
        'J.A.G.O.D.A is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'J.A.G.O.D.A is loading a response',
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). J.A.G.O.D.A won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'J.A.G.O.D.A needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'J.A.G.O.D.A needs a credential to continue.',
