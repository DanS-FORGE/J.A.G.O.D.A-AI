...
export const zh: Translations = {
  ...
  notifications: {
    ...
    native: {
      ...
      rejectAction: '拒绝',
      inputTitle: '需要输入',
      inputBody: 'J.A.G.O.D.A 正在等待你的回应。',
      turnDoneTitle: 'J.A.G.O.D.A 已完成',
      turnDoneBody: '',
      turnErrorTitle: '本轮失败',
  ...
  settings: {
    ...
    notifications: {
      ...
      kinds: {
        ...
        input: {
          label: '需要输入',
          description: 'J.A.G.O.D.A 提出了问题，或需要密码或密钥。'
        },
        turnDone: {
          label: '回复就绪',
    ...
    appearance: {
      ...
      reactionsTitle: '消息回应',
      reactionsDesc: 'iMessage 风格的表情回应 — 你可以给消息添加回应，J.A.G.O.D.A 也能回应你的消息。',
      ...
      pet: {
        title: '宠物',
        intro:
          '领养一只悬浮在应用上的 petdex 动画宠物，它会根据 J.A.G.O.D.A 的状态做出反应——工具执行时奔跑、成功时欢呼、出错时沮丧。',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: '当 J.A.G.O.D.A 需要本地时间上下文时使用。留空则使用系统时区。',
      agent: {
        imageInputMode: '控制图片附件如何发送给模型。',
        maxTurns: 'J.A.G.O.D.A 停止一次运行前工具调用轮次的上限。'
      },
      terminal: {
        cwd: '工具与终端操作的默认项目目录。',
      ...
      fileReadMaxChars: 'J.A.G.O.D.A 单次文件读取可读取的最大字符数。',
      approvals: {
        mode: 'J.A.G.O.D.A 如何处理需要显式审批的命令。',
    ...
    connections: {
      title: '已注册网关',
      intro: '管理本机以及通过远程、SSH 或 J.A.G.O.D.A Cloud 连接可访问的每个 J.A.G.O.D.A 网关。',
      stagedNote:
      ...
      updateSkippedCloud: '由 J.A.G.O.D.A Cloud 托管',
      kindLocal: '本地',
      kindRemote: '远程网关',
      ...
      kindCloudDesc: '通过你的 J.A.G.O.D.A Cloud 账户发现的托管实例。',
      ...
      cloudAddHint: '提示：在上方登录 J.A.G.O.D.A Cloud 可自动发现你的智能体——此表单仅用于手动注册已知的实例 URL。',
      save: '保存连接',
      saving: '保存中…',
      cancel: '取消',
      empty: '尚未注册任何连接。'
    ...
    gateway: {
      ...
      cloudDesc: '只需登录 J.A.G.O.D.A Cloud 一次，即可从你账户下的智能体中选择——无需粘贴 URL。',
      cloudSignInTitle: 'J.A.G.O.D.A Cloud',
      cloudSignIn: '登录 J.A.G.O.D.A Cloud',
      cloudSignedIn: '已登录 J.A.G.O.D.A Cloud',
      cloudNeedsSignIn: '登录 J.A.G.O.D.A Cloud 以发现你账户下的智能体。',
      ...
      cloudDiscoverFailed: '无法加载你的 J.A.G.O.D.A Cloud 智能体',
      cloudConnectFailed: '无法连接到该智能体',
      cloudSignInFailed: 'J.A.G.O.D.A Cloud 登录失败',
      cloudSignedOutTitle: '已退出 J.A.G.O.D.A Cloud',
      cloudSignedOutMessage: '已清除 J.A.G.O.D.A Cloud 会话。',
      ...
      sshHermesPathTitle: 'J.A.G.O.D.A 路径（可选）',
      ...
      sshReachable: (host, platform) => `可连接：${host}（${platform}）——已找到 J.A.G.O.D.A`,
      ...
      sshErrNotInstalled:
        '远程主机上未安装 J.A.G.O.D.A。请在远程安装（curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh）或设置 J.A.G.O.D.A 路径。',
  ...
  starmap: {
    ...
    loading: '加载中…',
    emptyTitle: '尚无学习内容',
    emptyDesc: '当 J.A.G.O.D.A 为你的工作构建技能和记忆时，会显示在这里。',
    share: '分享图谱',
  ...
  commandCenter: {
    ...
    generatePet: {
      ...
      backgroundHint: '你可以关闭此窗口——完成后 J.A.G.O.D.A 会通知你。',
  ...
  cron: {
    ...
    newCron: '新建定时任务',
    emptyDescNew: '按 cron 表达式排程一个提示词。J.A.G.O.D.A 会运行它，并把结果发送到你选择的目的地。',
  ...
  composer: {
    ...
    attachUrlDesc: 'J.A.G.O.D.A 将抓取该页面并作为本回合的上下文。',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: '让 J.A.G.O.D.A 提交并开 PR',
  ...
  install: {
    ...
    backToSetup: '返回',
    failedTitle: '安装失败',
    settingUpTitle: '正在设置 J.A.G.O.D.A Agent',
    finishingTitle: '正在收尾',
    failedDesc:
      '某个安装步骤失败。在 Windows 上，如果另一个 J.A.G.O.D.A CLI 或桌面实例正在运行，可能会出现这种情况。请停止正在运行的 J.A.G.O.D.A 实例后重试。可查看下面的详情或 desktop 日志中的完整记录。',
  ...
  onboarding: {
    headerTitle: '开始设置 J.A.G.O.D.A Agent',
  ...
  preview: {
    ...
    web: {
      ...
      failedToLoad: '预览加载失败',
      tryAgain: '重试',
      restarting: 'J.A.G.O.D.A 正在重启...',
      askRestart: '让 J.A.G.O.D.A 重启服务器',
      lookingRestart: taskId => `J.A.G.O.D.A 正在查找要重启的预览服务器 (${taskId})`,
      restartingTitle: '正在重启预览服务器',
      restartingMessage: 'J.A.G.O.D.A 正在后台工作。可在预览控制台查看进度。',
      ...
      blankPageBody: '在上方输入地址开始浏览，或让 J.A.G.O.D.A 打开一个页面。',
      finishedRestarting: message => `J.A.G.O.D.A 已完成预览服务器重启${message ? `: ${message}` : ''}`,
      failedRestarting: message => `服务器重启失败：${message}`,
      unknownError: '未知错误',
      restartedTitle: '预览服务器已重启',
      reloadingNow: '正在重新加载预览。',
      restartFailedTitle: '预览重启失败',
      restartFailedMessage: 'J.A.G.O.D.A 无法重启服务器。',
      stillWorking: 'J.A.G.O.D.A 仍在工作，但还没有收到重启结果。服务器命令可能正在前台运行。',
  ...
  assistant: {
    thread: {
      ...
      showEarlier: '显示更早的消息',
      loadingResponse: 'J.A.G.O.D.A 正在加载回复',
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `这会将“${pattern}”模式加入永久允许列表 (~/.hermes/config.yaml)。J.A.G.O.D.A 对类似命令将不再询问，包括当前会话和未来会话。`,
      alwaysAllow: '始终允许'
    },
    clarify: {
      notReady: '澄清请求尚未就绪',
  ...
  prompts: {
    ...
    sudoTitle: '管理员密码',
    sudoDesc: 'J.A.G.O.D.A 需要你的 sudo 密码来运行特权命令。它只会发送给你的本地 agent。',
    sudoPlaceholder: 'sudo 密码',
    secretTitle: '需要密钥',
    secretDesc: 'J.A.G.O.D.A 需要一个凭据才能继续。',
