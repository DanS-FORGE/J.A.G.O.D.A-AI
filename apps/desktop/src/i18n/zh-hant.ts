...
export const zhHant = defineLocale({
  ...
  notifications: {
    ...
    native: {
      ...
      rejectAction: '拒絕',
      inputTitle: '需要輸入',
      inputBody: 'J.A.G.O.D.A 正在等待你的回應。',
  ...
  settings: {
    ...
    notifications: {
      ...
      kinds: {
        ...
        input: {
          label: '需要輸入',
          description: 'J.A.G.O.D.A 提出了問題，或需要密碼或密鑰。'
        },
        turnDone: {
          label: '回覆就緒',
    ...
    appearance: {
      ...
      reactionsTitle: '訊息回應',
      reactionsDesc: 'iMessage 風格的表情回應 — 你可以對訊息做出回應，J.A.G.O.D.A 也能回應你的訊息。',
      ...
      pet: {
        title: '寵物',
        intro:
          '領養一隻懸浮在應用上的 petdex 動畫寵物，它會根據 J.A.G.O.D.A 的狀態做出反應——工具執行時奔跑、成功時歡呼、出錯時沮喪。',
        restartHint:
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: 'J.A.G.O.D.A 需要本機時間上下文時使用。留空則使用系統時區。',
      agent: {
        imageInputMode: '控制圖片附件如何傳送給模型。',
        maxTurns: 'J.A.G.O.D.A 停止一次執行前的工具呼叫輪次上限。'
      },
      terminal: {
      ...
      fileReadMaxChars: 'J.A.G.O.D.A 單次檔案讀取可讀取的最大字元數。',
      approvals: {
        mode: 'J.A.G.O.D.A 如何處理需要明確批准的指令。',
    ...
    gateway: {
      ...
      sshHermesPathTitle: 'J.A.G.O.D.A 路徑（選用）',
      ...
      sshReachable: (host, platform) => `可連線：${host}（${platform}）——已找到 J.A.G.O.D.A`,
      ...
      sshErrNotInstalled:
        '遠端主機上未安裝 J.A.G.O.D.A。請在遠端安裝（curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh）或設定 J.A.G.O.D.A 路徑。',
  ...
  starmap: {
    ...
    loading: '載入中…',
    emptyTitle: '尚無學習內容',
    emptyDesc: '當 J.A.G.O.D.A 為你的工作建立技能與記憶時，會顯示在這裡。'
  },
  agents: {
    close: '關閉代理',
    title: '派生樹',
  ...
  commandCenter: {
    ...
    generatePet: {
      ...
      backgroundHint: '你可以關閉此視窗——完成後 J.A.G.O.D.A 會通知你。',
  ...
  cron: {
    ...
    newCron: '新排程工作',
    emptyDescNew: '按 cron 表達式排程一個提示詞。J.A.G.O.D.A 會執行它，並將結果傳送至您選擇的目的地。',
  ...
  composer: {
    ...
    attachUrlDesc: 'J.A.G.O.D.A 將擷取該頁面並作為此回合的脈絡。',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: '讓 J.A.G.O.D.A 提交並開 PR',
  ...
  install: {
    ...
    backToSetup: '返回',
    failedTitle: '安裝失敗',
    settingUpTitle: '正在設定 J.A.G.O.D.A Agent',
    finishingTitle: '正在收尾',
    failedDesc:
      '某個安裝步驟失敗。在 Windows 上，如果另一個 J.A.G.O.D.A CLI 或桌面執行個體正在執行，可能會出現這種情況。請停止正在執行的 J.A.G.O.D.A 執行個體後重試。可查看下方的詳細資訊或 desktop 記錄中的完整記錄。',
  ...
  onboarding: {
    headerTitle: '開始設定 J.A.G.O.D.A Agent',
  ...
  preview: {
    ...
    web: {
      ...
      failedToLoad: '預覽載入失敗',
      tryAgain: '重試',
      restarting: 'J.A.G.O.D.A 正在重新啟動...',
      askRestart: '請 J.A.G.O.D.A 重新啟動伺服器',
      lookingRestart: taskId => `J.A.G.O.D.A 正在尋找要重新啟動的預覽伺服器 (${taskId})`,
      restartingTitle: '正在重新啟動預覽伺服器',
      restartingMessage: 'J.A.G.O.D.A 正在背景執行。可在預覽主控台查看進度。',
      ...
      blankPageBody: '在上方輸入網址開始瀏覽，或請 J.A.G.O.D.A 開啟頁面。',
      finishedRestarting: message => `J.A.G.O.D.A 已完成預覽伺服器重新啟動${message ? `：${message}` : ''}`,
      failedRestarting: message => `伺服器重新啟動失敗：${message}`,
      unknownError: '未知錯誤',
      restartedTitle: '預覽伺服器已重新啟動',
      reloadingNow: '正在重新載入預覽。',
      restartFailedTitle: '預覽重新啟動失敗',
      restartFailedMessage: 'J.A.G.O.D.A 無法重新啟動伺服器。',
      stillWorking: 'J.A.G.O.D.A 仍在執行，但尚未收到重新啟動結果。伺服器指令可能正在前台執行。',
  ...
  assistant: {
    thread: {
      ...
      showEarlier: '顯示較早的訊息',
      loadingResponse: 'J.A.G.O.D.A 正在載入回覆',
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `這會將「${pattern}」模式加入永久允許清單（~/.hermes/config.yaml）。J.A.G.O.D.A 對類似指令將不再詢問，包括目前工作階段和未來工作階段。`,
      alwaysAllow: '一律允許'
    },
    clarify: {
      notReady: '澄清請求尚未就緒',
  ...
  prompts: {
    ...
    sudoTitle: '管理員密碼',
    sudoDesc: 'J.A.G.O.D.A 需要您的 sudo 密碼來執行特權指令。它只會傳送給您的本機代理。',
    sudoPlaceholder: 'sudo 密碼',
    secretTitle: '需要密鑰',
    secretDesc: 'J.A.G.O.D.A 需要一個憑證才能繼續。',
