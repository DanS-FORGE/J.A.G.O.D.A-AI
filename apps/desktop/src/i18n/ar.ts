...
export const ar = defineLocale({
  ...
  notifications: {
    ...
    native: {
      ...
      inputBody: 'ينتظر J.A.G.O.D.A ردّك.',
      turnDoneTitle: 'أنهى J.A.G.O.D.A',
      turnDoneBody: '',
  ...
  settings: {
    ...
    notifications: {
      ...
      kinds: {
        ...
        input: {
          label: 'يلزم إدخال',
          description: 'طرح J.A.G.O.D.A سؤالا أو يحتاج إلى كلمة مرور أو سر.'
        },
        turnDone: {
          label: 'الرد جاهز',
    ...
    appearance: {
      ...
      reactionsDesc: 'تفاعلات إيموجي بأسلوب iMessage — تفاعل مع الرسائل، ويمكن لـ J.A.G.O.D.A التفاعل مع رسائلك.',
      ...
      pet: {
        title: 'حيوان أليف',
        intro:
          'تبنَّ تعويذة petdex متحركة تطفو فوق التطبيق وتتفاعل مع ما يفعله J.A.G.O.D.A — تجري أثناء تنفيذ الأدوات، وتحتفل عند النجاح، وتعبس عند الأخطاء.',
        restartHint:
    ...
    fieldDescriptions: {
      ...
      timezone: 'تستخدم عندما يحتاج J.A.G.O.D.A إلى سياق الوقت المحلي. اتركها فارغة لاستخدام منطقة النظام.',
      'agent.imageInputMode': 'يتحكم في طريقة إرسال مرفقات الصور إلى النموذج.',
      'agent.maxTurns': 'الحد الأعلى لدورات استدعاء الأدوات قبل أن يوقف J.A.G.O.D.A التشغيل.',
      ...
      fileReadMaxChars: 'أقصى عدد أحرف يستطيع J.A.G.O.D.A قراءته من ملف واحد في الطلب.',
      'approvals.mode': 'كيف يتعامل J.A.G.O.D.A مع الأوامر التي تحتاج موافقة صريحة.',
  ...
  commandCenter: {
    ...
    generatePet: {
      ...
      backgroundHint: 'يمكنك إغلاق هذا — سيُعلِمك J.A.G.O.D.A عند الانتهاء.',
  ...
  cron: {
    ...
    emptyDescNew: 'أنشئ مهمة مجدولة لتشغيل J.A.G.O.D.A تلقائيا.',
    ...
    createDesc: 'اضبط مهمة يشغلها J.A.G.O.D.A تلقائيا.',
    nameLabel: 'الاسم',
    namePlaceholder: 'مثال: الملخص الصباحي',
    promptLabel: 'الرسالة',
    promptPlaceholder: 'ماذا تريد من J.A.G.O.D.A أن يفعل؟',
  ...
  composer: {
    ...
    newSessionPlaceholders: ['اسأل J.A.G.O.D.A عن شيء...', 'اطلب من J.A.G.O.D.A تنفيذ مهمة...', 'ابدأ محادثة جديدة...'],
    ...
    urlHintPre: 'سيقرأ J.A.G.O.D.A الرابط ضمن السياق.',
    attach: 'إرفاق',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'اطلب من J.A.G.O.D.A فتح PR',
  ...
  install: {
    ...
    settingUpTitle: 'جار إعداد وكيل J.A.G.O.D.A',
    finishingTitle: 'جار الإنهاء',
    failedDesc:
      'فشلت إحدى خطوات التثبيت. على Windows، قد يحدث هذا إذا كان هناك نسخة أخرى من J.A.G.O.D.A CLI أو تطبيق سطح المكتب قيد التشغيل. أوقف أي نسخ J.A.G.O.D.A قيد التشغيل، ثم أعد المحاولة. تحقق من التفاصيل أدناه أو من سجل سطح المكتب للحصول على النص الكامل.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: 'لنُعِدّ لك J.A.G.O.D.A Agent',
  ...
  preview: {
    ...
    web: {
      ...
      tryAgain: 'إعادة المحاولة',
      restarting: 'جار إعادة تشغيل J.A.G.O.D.A...',
      askRestart: 'اطلب من J.A.G.O.D.A إعادة تشغيل الخادم',
      lookingRestart: taskId => `يبحث J.A.G.O.D.A عن خادم معاينة لإعادة تشغيله (${taskId})`,
      restartingTitle: 'جار إعادة تشغيل خادم المعاينة',
      restartingMessage: 'يعمل J.A.G.O.D.A في الخلفية. راقب كونسول المعاينة لمتابعة التقدم.',
      ...
      blankPageBody: 'اكتب عنوانًا في الأعلى للتصفح، أو اطلب من J.A.G.O.D.A فتح صفحة.',
      finishedRestarting: message => `أنهى J.A.G.O.D.A إعادة تشغيل خادم المعاينة${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'تعذّر على J.A.G.O.D.A إعادة تشغيل الخادم.',
      stillWorking:
        'لا يزال J.A.G.O.D.A يعمل، لكن لم تصل نتيجة إعادة التشغيل بعد. قد يكون أمر الخادم قيد التشغيل في المقدمة.',
