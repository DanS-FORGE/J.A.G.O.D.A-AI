...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The J.A.G.O.D.A agent, your config, and chats all stay.',
  ...
  },
  {
    ...
    consequence: 'EVERYTHING — the Chat GUI, the J.A.G.O.D.A agent, and all of your config, chats, secrets, and logs',
