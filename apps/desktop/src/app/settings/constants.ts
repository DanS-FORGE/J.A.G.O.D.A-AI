...
export const FIELD_DESCRIPTIONS: Record<string, string> = defineFieldCopy({
  ...
  agent: {
    ...
    maxTurns: 'Upper bound for tool-calling turns before J.A.G.O.D.A stops a run.'
  },
  terminal: {
  ...
  fileReadMaxChars: 'Maximum characters J.A.G.O.D.A can read from one file request.',
  approvals: {
    mode: 'How J.A.G.O.D.A handles commands that need explicit approval.',
