...
J.A.G.O.D.A-owned Relay transport health remains in scope. A separate gateway
...
release covers only J.A.G.O.D.A-owned service-health and operational-diagnostic
signals, including J.A.G.O.D.A-owned Relay transport health. Team Gateway's
